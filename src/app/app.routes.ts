...
import { BrandsDetailsComponent } from './features/brands-details/brands-details.component';
import { SubcategoriesComponent } from './features/subcategories/subcategories.component';
import { SubcategoriesDetailsComponent } from './features/subcategories-details/subcategories-details/subcategories-details.component';
...
export const routes: Routes = [
    ...
    {path : 'checkout/:cartId' , component : CheckoutComponent ,title : 'Fresh Cart' ,canActivate : [authGuard]},
    ...
    {path : 'brands-details/:id' , component : BrandsDetailsComponent ,title : 'Fresh Cart'},

    {path : 'subcategories/:id' , component : SubcategoriesComponent ,title : 'Fresh Cart'},
